...
def sandbox_to_get_holidays(tradingDB: trading_oanda_database):
    ...
    # Local_opening_hours_4: TD 00:00 - TD 19:59 (UK100_GBP for local trading dates >= 2015-10-01)
    # Local_opening_hours_5: TD 08:00 - TD 19:59 (UK100_GBP for local trading dates < 2015-10-01)
    # Local_opening_hours_6: PD 18:00 - TD 16:59 (XAU_EUR)
    # Local_opening_hours_7: PD 17:00 - None; TD 00:00 - 16:59:59 (EUR_USD,EUR_CHF,EUR_GBP,EUR_JPY)
