...
apiKey = "TieQTlkZBOIwcUtjw6bTW7eX"
apiSecret = "SEz15sgHEpVVgVA2kqx6mFG6L2WuScXbkWbH9xzrKRzywtY_"
client = bitmex.bitmex(api_key=apiKey, api_secret=apiSecret)

# a = client.Instrument.Instrument_getActive().result()
# print(a)
#
#
# # b = client.Quote.Quote_get(symbol='XBTUSD').result()
# # print(b)
#
...
# expires = 1548973380.0 # 2019-01-31 23:23
# data = ''
#
